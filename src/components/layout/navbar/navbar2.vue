    ...
    <div class="container">
      ...
      <div id="navMenu" class="navbar-menu">
        <div class="navbar-start">
          <a class="navbar-item"  v-for="system in systems" @click="selectSystem(system.subsystemId)" :key="system.subSystemId">
...
//            && ( activeSystem == undefined || activeSystem == '')
