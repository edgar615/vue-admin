    ...
    <div class="card">
      <div class="card-content">
        <b-field grouped group-multiline>
          ...
          <b-datepicker
            placeholder=""
            :min-date="filters.startTime" v-model="filters.startTime"
            >
          </b-datepicker> ~
          <b-datepicker
            placeholder=""
            :max-date="filters.endTime" v-model="filters.endTime">
          </b-datepicker>
    ...
    <div class="card mt-3">
      <div class="card-content">
        <div class="field is-grouped">
          <div class="buttons" >
            <router-link to="/shop/recruitment/add"
        ...
        >
          ...
          <template slot-scope="props">
            ...
            <b-table-column label="操作">
              ...
              <router-link :to="{path:  '/shop/recruitment/ ' +props.row.recruitmentId + '/edit' }"
                           title="编辑">
                编辑
              </router-link>
              <a @click="onDelete(props.row.recruitmentId)"
                      title="删除" >
                删除
              </a>
    ...
    methods: {
      ...
      loadAsyncData (params) {
        if (this.filters.startTime) {
          this.filters.startTime = this.filters.startTime.getTime();
        }
        if (this.filters.startTime) {
          this.filters.endTime = this.filters.endTime.getTime();
        }
