  ...
  <section>
    ...
    <div class="wrap-box">
      ...
      <div class="message-box">
        <div class="Input-box">
          <b>宠物品种：</b>
          <b-input v-model="name" class="input-custom"  placeholder="请输入"></b-input>
        </div>
        ...
        <div class="Input-box">
          ...
          <b-select placeholder="请选择">
            <option
              v-for="option in dictList(this, 'petLevel')"
        ...
        <div class="Input-box">
          <b class="Input-title">价格：</b>
          <b-select placeholder="请选择">
            <option
              v-for="option in dictList(this, 'petPrice')"
              :value="option.dictValue"
              :key="option.dictValue">
              {{ option.dictText }}
            </option>
        ...
        <div class="Input-box">
          <b class="Input-title">状态：</b>
          <b-select placeholder="请选择">
            <option
              v-for="option in dictList(this, 'petStatus')"
              :value="option.dictValue"
              :key="option.dictValue">
              {{ option.dictText }}
            </option>
