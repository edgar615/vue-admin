          ...
          >
            ...
            <template slot-scope="props">
              ...
              <b-table-column label="操作">
                ...
                <a  v-if="props.row.state==1 || props.row.state==3 || props.row.state==4" @click="onCancel(props.row.purchaseOrderId)"
                    title="" >
                  取消订单
                </a>
                <a  v-if="props.row.state==2 || props.row.state==6 || props.row.state==5"  style="opacity: 0.3;">
                  取消订单
                </a>
              </b-table-column>
            </template>
...
<script>
  import {returnOrderPage } from '@/api/franchiser/returnorder'
