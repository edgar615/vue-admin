      ...
      <div class="card mt-3 Table-custom"  rules=none>
        ...
        @page-change="onPageChange"
          ...
          <template slot-scope="props">
            ...
            <b-table-column field="name" label="会员名称" centered>
              {{  props.row.name }}
            </b-table-column>

            <b-table-column field="tel" label="消费时间" centered>
              {{ props.row.tel }}
            </b-table-column>

            <b-table-column field="gender" label="消费金额"  centered >
              <!--{{ dictText(this, "paymentType",props.row.type) }}-->
              {{  props.row.birthday  }}
            </b-table-column>

            <b-table-column field="registerTime" label="生成积分"  centered >
               {{ props.row.registerTime }}
            </b-table-column>

            <b-table-column field="state" label="会员总消费金额（元）" centered>
            ...
            <b-table-column field="type" label="门店"  centered >

              <b-table-column field="amount" label="XXXX店"  centered >
                {{ props.row.memberPoints}}
              </b-table-column>
