  ...
  <section>
    <div class="form-modal-card-body">
      ...
      <b-field class="field"  message="辅助功能，自动生成CRUD菜单"
                 v-show="model.type == 1 && parentId == -1">
...
<script>
  import {addMenu} from '@/api/backend/system'
  ...
  export default {
    data () {
      return {
        ...
        saving: false,
        model: {
          subsystemId: this.$parent.$props.props.systemId,
          parentId: this.$parent.$props.props.parentId,
        }
      }
    },
    methods: {
